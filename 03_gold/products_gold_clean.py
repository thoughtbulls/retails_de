...
silver_df = (
    spark.readStream \
        ...
        .table("retails.silver.products_cleaned")
)
...
query = (
    silver_df.writeStream
        ...
        .option(
            "checkpointLocation",
            "dbfs:/Volumes/data/raw/_checkpoints/retails/dev/gold/products_clean/"
        )
...
# MAGIC %sql
# MAGIC -- make silver cleaned table CDF enabled
# MAGIC
# MAGIC -- ALTER TABLE retails.silver.products_cleaned
# MAGIC -- SET TBLPROPERTIES (
# MAGIC --     delta.enableChangeDataFeed = true
# MAGIC -- )
# MAGIC
# MAGIC -- DESCRIBE TABLE EXTENDED retails.silver.products_cleaned;
